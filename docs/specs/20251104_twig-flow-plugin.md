...
| P1       | Plan integration tests & fixtures.                                         | List of test scenarios with coverage goals.                                                                               | Include tree rendering snapshots, switching success/error cases.                     |                                                                                                                                        |
                                                            |
| P1       | Surface branch commit deltas in visualization.                             | Renderer outputs `+<n>` for commits unique to the branch and `-<n>` for commits missing relative to parent.                 | Adds parent comparison overlay to tree/table output so users can see divergence at a glance.                               |
                                                            |
