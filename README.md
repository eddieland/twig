...
Security is a top priority for Twig. We follow security best practices and regularly update dependencies to address vulnerabilities.

### Reporting Security Issues

If you discover a security vulnerability, please report it responsibly:

- **For sensitive vulnerabilities**: Use GitHub's [private vulnerability reporting](https://github.com/eddieland/twig/security/advisories/new) feature
- **For general security improvements**: Open a [security issue](https://github.com/eddieland/twig/issues/new?template=security.yml)

Please see our [Security Policy](.github/SECURITY.md) for more details.

### Security Features

- **Secure credential storage**: Uses `.netrc` files with proper permissions
- **No hardcoded secrets**: All authentication uses environment variables or credential files
- **Dependency scanning**: Automated vulnerability scanning with Dependabot
- **Signed releases**: All releases include SHA256 checksums for verification
...
- **Issues**: Report bugs or request features via [GitHub Issues](https://github.com/eddieland/twig/issues)
- **Discussions**: Join the conversation in [GitHub Discussions](https://github.com/eddieland/twig/discussions)

## Acknowledgments

Thanks to all contributors who have helped make Twig better!
